...
if (healthCheck) {
    ...
    healthCheck.response[0].body = JSON.stringify({
        "status": "success",
    ...
    // Create if missing (it should be there from previous step, but safe to handle)
...
console.log('Postman collection updated with correct Health Check URL!');
